...
class Task {
    constructor() {
         ...
         * @type {string}
         */
        this.script_address = "http://quantum.nebula-ai.network/script/Nebula_LSTM.py";
        /**
         * Quantum does not need data input
         * @type {string}
         */
        this.data_address = "";
        /**
         * Server address, where data is stored
         * @type {string}
         */
        this.output_address = "http://quantum.nebula-ai.network/nebula/scripts/";
        /**
         * Any parameter that will be passed with script for calculation
         * @type {{}}
         */
        this.params = {};
        /**
        ...
        this.app_id = 0;
        /**
         * Task ID, related to nebula main contract
         * @type {number}
         */
        this.task_id = 0;
        /**
         * UUID of the current task
         * WIP V1.2 This will be replaced by the task contract address
         * @type {string}
         */
        this.uuid = "";
 ...
 * @type {string}
 */
const nebula_abi_url = "abi/NebulaAi.json";
/**
 * Either use url like : "http://quantum.nebula-ai.network/assets/ABI/Task_1.json";
 * Or load by relative path like : "abi/Task_1.json"
 * @type {string}
 */
const task_abi_url = "abi/Task_1.json";
/**
 * WIP V1.2 separating nebula base contract with application contract
 * @type {string} The base contract address
 */
let nebula_address = "";
/**
 ...
 * @type {string}
 */
let contract_address = "0x45677a1af702817b00858d6a202136ac3cdc4dca"; //Helix v0.2
/**
 *
 * @type {{}}
 */
...
(function () {
    ...
    window.addEventListener('load', function () {
        ...
        if (!isFirefox && !isChrome) {
            window.open("templates/browser.html", "_self");
        } else {
            ...
            if (typeof web3 !== 'undefined') {
                ...
                // TODO not necessary to add this http provider
                // web3 = new Web3(new Web3.providers.HttpProvider("http://18.221.71.211:8545"));
                window.open("templates/metamask.html", "_self");
            }
        }
    });
})();
...
function getUuid() {
    taskContractInstance.uuid(function (error, result) {
        if (error) {
            ...
            let output_uuid = web3.toAscii(result);
            console.log(output_uuid);
