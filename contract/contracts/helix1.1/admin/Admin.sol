...
contract Admin is Ownable {
    ...
    function set_all() ownerOnly public returns (bool){
        ...
        client.set_addresses(dispatcher_address, distributor_address, client_address, account_address, address(0));
        distributor.set_addresses(dispatcher_address, distributor_address, client_address, taskpool_address, address(0));
        dispatcher.set_addresses(dispatcher_address, distributor_address, client_address, queue_ai_address, queue_task_address);

        account.set_client(client_address);
        taskpool.set_distributor(distributor_address);
        queue_task.set_dispatcher(dispatcher_address);
        queue_ai.set_dispatcher(dispatcher_address);
    }
}
